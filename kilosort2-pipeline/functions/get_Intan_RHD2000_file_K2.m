function return_data = get_Intan_RHD2000_file_K2(path, file, quiet, moveTo, probechannels)
% return_data = {amplifier_data elapsedTime amplifier_channels frequency_parameters};

% Modified by David Giles 5/22/17
% 
% Made function callable, taking in a directory and filename.
% Changed name to 'get_Intan...' instead of 'read_....'
% Also implemented a quiet mode to not write as much progress text to command window.
% 
% Usage, quiet=1 mutes most messages (except starting and done);
% moveTo=1 moves all variables created to base workspace, otherwise skip
% step
%
% ----------End Changes----------
%
...
% 6/21 added amplifier_channels and frequency_parameters
return_data = {amplifier_data(probechannels,:)};
% return_data = {amplifier_data(probechannels,:) elapsedTime amplifier_channels frequency_parameters};
